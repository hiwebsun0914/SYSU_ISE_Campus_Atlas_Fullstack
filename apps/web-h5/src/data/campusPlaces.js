...
export const CATEGORY_MAP = {
  ...
  canteen:   { label: "食堂",     icon: "🍜", color: "#f97316" },
  dormitory: { label: "宿舍",     icon: "🏠", color: "#8b5cf6" },
  library:   { label: "图书馆",   icon: "📖", color: "#0d9488" },
  sports:    { label: "运动场",   icon: "⚽", color: "#ef4444" },
  landscape: { label: "景观",     icon: "🌳", color: "#22c55e" },
  service:   { label: "生活服务", icon: "🏪", color: "#64748b" },
};
...
export const campusLocations = [
  {
    ...
    category: "landmark",
    position: "南校园311号",
    tags: ["老建筑","历史","上课","宿舍区","人文"],
    shortDesc: "何尔达屋（Holt Residence），原称34号住宅，现位于中山大学东北区311号，现为中山大学学报编辑部。该建筑由岭南大学美籍教员何尔达（Alfred H",
  ...
  },
  {
    ...
    category: "landmark",
    position: "南校园313号",
    tags: ["老建筑","历史","宿舍区","活动","人文"],
    shortDesc: "高利士屋（Coles Lodge），又译高礼士屋、高士屋，原37号住宅，现位于中山大学东北区313号。该建筑由美国医生艾克曼·高利士（Dr",
  ...
  },
  {
    ...
    position: "南校园317号",
    tags: ["老建筑","历史","宿舍区","活动"],
    shortDesc: "宾省校屋（Penn State Lodge），又称宾省大学屋，原45号住宅，现位于中山大学东北区317号。该建筑由岭南大学农学院院长高鲁甫（George Weidman Groff）的母校——美...",
  ...
  },
  {
    ...
    position: "南校园317栋东南侧",
    tags: ["雕塑","地标","拍照","自习","藏书"],
    shortDesc: "端木正教授像，位于中山大学康乐园图书馆东门旁。这座半身铜像的铭文为：“法学家 历史学家 端木正教授（1920–2006）”，为纪念这位学识渊博的教育家与法学大家而设",
  ...
  },
  {
    ...
    category: "landmark",
    position: "南校园318号",
    tags: ["老建筑","历史","上课","宿舍区","活动"],
    shortDesc: "韦耶孝实屋（Weyerhaeuser Lodge），又译卫厚实屋、委夏士屋、威尔豪士屋，原46号住宅，现位于中山大学东北区318号。该建筑由美国韦耶孝实夫人（Mrs",
  ...
  },
  {
    ...
    position: "南校园316号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "伦敦会屋（London Mission Lodge），又称L。M",
  ...
  },
  {
    ...
    position: "南校园319号",
    tags: ["宿舍区","人文"],
    shortDesc: "美臣屋一号（Mason Lodge No。1），原47号住宅，现位于中山大学东北区319号",
  ...
  },
  {
    ...
    position: "南校园324号",
    tags: ["老建筑","历史","上课","宿舍区","活动"],
    shortDesc: "白德理屋（Bradley House），又称白德理纪念屋，原53号住宅，现位于中山大学东北区324号。该建筑由白德理先生为纪念其妻Lois Gates Bradley捐建，建成年份约在1927年前后",
  ...
  },
  {
    ...
    position: "南校园329号",
    tags: ["老建筑","历史","上课","宿舍区"],
    shortDesc: "屈林宾屋（William Penn Lodge），又译威林滨屋、威林宾屋，原54号住宅，现位于中山大学东北区329号。该建筑由岭南学校医学家嘉惠林医生（Dr",
  ...
  },
  {
    ...
    position: "南校园332号",
    tags: ["老建筑","历史","上课","宿舍区"],
    shortDesc: "惠师礼屋（Wesley House），又译卫斯理会屋，又称李富士屋，原49号住宅，现位于中山大学东北区332号。该建筑由英格兰惠师礼循道会（Wesleyan Methodist Missiona...",
  ...
  },
  {
    ...
    position: "南校园338号",
    tags: ["老建筑","历史","活动"],
    shortDesc: "马岗堂（Lingnan Chapel），又称马岗顶礼拜堂、岭南礼拜堂、新教堂，原属岭南大学校园编号85号建筑，现位于中山大学东北区338号。该建筑由岭南社团及海外友人捐建，于1936年落成",
  ...
  },
  {
    ...
    position: "南校园335号",
    tags: ["自习","藏书"],
    shortDesc: "中山大学图书馆，始建于1924年，历经近百年发展，现已成为覆盖文、理、医、工、农、艺术等多学科的综合性文献信息服务中心。 馆藏资源： 实体文献逾1000万册/件 古籍36万余册，民国文献14万余...",
  ...
  },
  {
    ...
    position: "南校园图书馆五楼南区",
    tags: ["雕塑","地标","拍照","自习","藏书"],
    shortDesc: "黄焕秋校长像，位于中山大学广州校区南校园图书馆五楼南区，铜像目光如炬、面容温和，静静伫立于书香之间。这位被师生亲切唤作“焕秋同志”的老校长，被誉为“革命的教育家、教育的革命家”，其雕像与图书馆的...",
  ...
  },
  {
    ...
    position: "南校园333号",
    tags: ["老建筑","历史","自习","藏书"],
    shortDesc: "格兰堂（Grant Hall），因为一口大钟掌握园内上下课时间，所以又称大钟楼。原63号建筑，现位于中山大学东北区333号,现为校史馆",
  ...
  },
  {
    ...
    position: "南校园333栋东侧",
    tags: ["雕塑","地标","拍照","自习","藏书"],
    shortDesc: "廖承志像，位于中山大学南校园图书馆南侧绿地。雕像为半身铜像，人物手托腮帮，面带微笑，神情和蔼，仿佛随时倾听后辈",
  ...
  },
  {
    ...
    category: "landmark",
    position: "南校园334号",
    tags: ["老建筑","历史","自习","藏书","上课"],
    shortDesc: "马丁堂（Martin Hall），原61号建筑，现位于中山大学东北区334号。该堂由美国纽约斯道顿建筑师事务所（Stoughton & Stoughton Architects）设计，1905年...",
  ...
  },
  {
    ...
    tags: ["运动","上课","活动"],
    shortDesc: "附属小学建筑群，现位于中山大学东北区339-346号，由8栋楼和1座方亭构成。其中东北区339-345号共7栋楼呈南北走向阶梯斜列；东北区346号与方亭则位于斜列以西，落成年代稍晚",
  ...
  },
  {
    ...
    category: "canteen",
    position: "南校园347号",
    tags: ["餐饮","景观","拍照","上课","宿舍区"],
    shortDesc: "南草坪餐厅，位于中山大学南校园南草坪区域，是校园内重要的学生食堂之一。餐厅整体设计简洁实用，服务于大规模的学生日常就餐需求",
  ...
  },
  {
    ...
    position: "南校园348号",
    tags: ["上课","活动"],
    shortDesc: "第一教学楼，位于中山大学南校园348栋，是康乐园内规模较大的教学建筑之一。全楼共六层，以多媒体阶梯课室为主，是本科生上课的核心场所",
  ...
  },
  {
    ...
    position: "南草坪餐厅后",
    tags: ["校园"],
    shortDesc: "方亭，位于中山大学东北区342号以西，是康乐园早期校园建筑群的重要组成部分之一。该亭建成时间早于民国二十一年（1932），为岭南校园生活与交流空间提供了别样的文化氛围",
  ...
  },
  {
    ...
    position: "南校园350号",
    tags: ["老建筑","历史","宿舍区","活动","人文"],
    shortDesc: "荣光堂（Wing Kwong Hall），原21号建筑，现位于中山大学东北区350号。该建筑由埃德蒙兹（Jas",
  ...
  },
  {
    ...
    position: "-",
    tags: ["校园"],
    shortDesc: "中山大学南门，是广州南校园的标志性大门之一，也是最具辨识度的校门形象。南门面向广州市海珠区新港西路，正对康乐园的中轴线，承载了学校厚重的历史记忆与文化象征",
  ...
  },
  {
    ...
    position: "南校园408号",
    tags: ["上课","活动","人文"],
    shortDesc: "中山大学生命科学学院，前身可追溯至1924年建校伊始设立的生物学系，于1991年正式成立生命科学学院。学院位于广州校区南校园，是中国生命科学领域的重要教学与科研中心",
  ...
  },
  {
    ...
    position: "南校园410号",
    tags: ["宿舍区","人文"],
    shortDesc: "蚕丝学院制种室，又称育蚕制种场、飞利达育蚕室、蚕科宿舍、蚕丝传习所，原40号建筑，现位于中山大学西南区410号。该楼由纽约丝绸进口商马科斯·飞利达（Marcus Fieldler，又译富利达）捐...",
  ...
  },
  {
    ...
    position: "南校园415号",
    tags: ["上课","活动"],
    shortDesc: "生物楼，位于中山大学南校园415栋，是中大生物学科在康乐园发展的重要历史见证。 历史沿革： 1950年代：根据全国院系大调整，岭南大学生物学系并入中山大学生物学系，系所从石牌校区迁往康乐村",
  ...
  },
  {
    ...
    position: "南校园生物楼正前方",
    tags: ["雕塑","地标","拍照","活动"],
    shortDesc: "达尔文半身雕像，矗立于中山大学南校园的旧生物楼（即“旧生物楼”—南校园415栋）前，是生命科学学子心中的精神坐标。 历史沿革： 雕像由中山大学生物系1979级校友捐赠，具体捐赠时间为1983年",
  ...
  },
  {
    ...
    tags: ["老建筑","历史","上课","宿舍区","活动"],
    shortDesc: "曾宪梓堂（Tsang Yam Shee Hall），位于中山大学南校园，为生命科学学院的教学、科研与办公大楼。该堂由中大杰出校友、香港金利来集团创办人曾宪梓博士慷慨捐建，1990年秋落成，共六层...",
  ...
  },
  {
    ...
    position: "曾宪梓堂北侧",
    tags: ["雕塑","地标","拍照","上课","活动"],
    shortDesc: "蒲蛰龙雕塑，位于中山大学南校园（生命科学学院片区），为纪念著名昆虫学家、植物保护学家蒲蛰龙先生而设。雕塑以朴素凝练的写实手法呈现学者风貌，传递“顺应生态、科学治虫”的绿色植保理念",
  ...
  },
  {
    ...
    position: "南校园475号",
    tags: ["老建筑","历史","上课","活动"],
    shortDesc: "马文辉堂（Ma Wenhui Hall），原475号建筑，现位于中山大学南校园，由爱国华侨马文辉先生捐资兴建。该楼落成于20世纪上半叶，是岭南大学时期的重要红砖建筑之一",
  ...
  },
  {
    ...
    position: "南校园478号",
    tags: ["老建筑","历史","上课"],
    shortDesc: "贺丹青堂（He Danqing Hall），原478号建筑，现位于中山大学南校园。该建筑以旅美爱国华侨贺丹青先生之名命名，是岭南大学时期的重要捐建楼宇之一",
  ...
  },
  {
    ...
    position: "南校园471号",
    tags: ["上课"],
    shortDesc: "测试大楼（Analysis and Testing Center Building），位于中山大学，为校级大型公共科研平台——中山大学分析测试中心的主体所在地。分析测试中心始建于1983年（原名...",
  ...
  },
  {
    ...
    tags: ["景观","拍照","人文"],
    shortDesc: "竹种标本园（Bamboo Garden），位于中山大学南校园贺丹青堂旁，是中国国内种类最为丰富的竹类标本园之一，其历史可追溯至岭南大学时期。 历史沿革： 20世纪20年代：由竹类分类学泰斗莫古礼...",
  ...
  },
  {
    ...
    position: "南校园474号",
    tags: ["宿舍区"],
    shortDesc: "中山楼（Sun Yat-sen Hall），位于中山大学南校园，是校园标志性建筑之一。该楼由著名爱国华侨、金利来集团创办人曾宪梓博士慷慨捐资1200万元兴建，于1999年6月破土动工，2001年...",
  ...
  },
  {
    ...
    position: "南校园487号",
    tags: ["老建筑","历史","活动","人文"],
    shortDesc: "梁銶琚堂，位于中山大学南校园487号，是校园标志性建筑之一。该堂于1982年秋奠基，1984年春竣工，由香港恒生银行有限公司董事、大昌贸易有限公司副董事长梁銶琚先生慷慨捐资港币600万元兴建",
  ...
  },
  {
    ...
    position: "南校园493号",
    tags: ["宿舍区","活动"],
    shortDesc: "中学第二寄宿舍，原74号建筑，现位于中山大学西南区493号。该建筑由柯林斯（A",
  ...
  },
  {
    ...
    position: "南校园486号",
    tags: ["老建筑","历史","上课","宿舍区","活动"],
    shortDesc: "张弼士堂，原92号建筑，现位于中山大学西南区486号。该建筑由上海布道团建筑师事务所（Mission Architects Bureau, Shanghai）设计师埃德蒙兹（Jas",
  ...
  },
  {
    ...
    position: "南校园494号",
    tags: ["餐饮","上课","宿舍区","活动"],
    shortDesc: "逸夫文化艺术中心，位于中山大学广州校区南校园东南区，毗邻学一食堂，步行约10–20分钟可达宿舍区，是南校园课室建筑群的重要组成部分。该楼由著名 philanthropist 邵逸夫先生捐资兴建，...",
  ...
  },
  {
    ...
    position: "学一食堂（496）后",
    tags: ["运动","上课","宿舍区","活动"],
    shortDesc: "西大操场，位于中山大学广州校区南校园西北区，建于1945年，紧邻教学楼与学生宿舍，是校园内历史悠久、影响深远的重要运动与集会场地。 历史沿革： 强国强种：1912年，孙中山就任临时大总统后，就立...",
  ...
  },
  {
    ...
    position: "南校园260号",
    tags: ["老建筑","历史","活动"],
    shortDesc: "冼为坚堂，位于中山大学广州校区南校园260号，是一座高等学术研究中心的研究大楼，由香港恒生银行董事、慈善家冼为坚博士慷慨捐资兴建。该楼主要用于各类学术会议与研究活动的举办，是校园内重要的学术交流...",
  ...
  },
  {
    ...
    position: "南校园259号",
    tags: ["餐饮","景观","拍照"],
    shortDesc: "紫荆园餐厅，位于中山大学广州校区南校园东南区（外国语学院后侧），是校园内环境优雅、专为正式宴请和早茶而设的餐饮场所，由邵逸夫先生曾资助兴建的紫荆园宾馆内设餐厅得名。 功能定位： 粤菜与早茶：提供...",
  ...
  },
  {
    ...
    tags: ["上课","宿舍区","活动"],
    shortDesc: "协和神学院建筑群，位于中山大学广州校区南校园东南区，现存261号、265号、268号三栋建筑，落成于1947–1948年间。 历史沿革： 1914年10月：协和神学院创办",
  ...
  },
  {
    ...
    position: "南校园262号",
    tags: ["老建筑","历史","上课"],
    shortDesc: "芙兰堂，原第三教学楼，位于中山大学广州南校园。因校友陈运河、刘修婉伉俪设立“芙兰奖”三十周年纪念，于2024年11月10日举行揭牌典礼，更名为“芙兰堂”",
  ...
  },
  {
    ...
    position: "南校园269号",
    tags: ["老建筑","历史"],
    shortDesc: "锡昌堂，位于中山大学广州校区南校园，由校友邹锡昌先生捐资2000万元建设，建筑面积11388平方米。 历史沿革： 2007年10月14日：锡昌堂奠基仪式举行，作为中山大学83周年校庆献礼",
  ...
  },
  {
    ...
    tags: ["宿舍区"],
    shortDesc: "四墩楼，又称“炮台屋”，位于中山大学广州校区南校园东南区234–237号，为四栋风格一致的教师住宅，呈平行四边形分布。 历史沿革： 建于20世纪30年代，属康乐园早期建筑群，采用红砖砌筑、砖混结...",
  ...
  },
  {
    ...
    position: "南校园240号",
    tags: ["宿舍区","医疗","人文"],
    shortDesc: "8号住宅，原为岭南大学时期编为8号的住宅，现位于中山大学广州校区南校园东南区240号。该建筑的具体建造年代和资金来源尚待考证",
  ...
  },
  {
    ...
    position: "南校园241号",
    tags: ["宿舍区","人文"],
    shortDesc: "孖[mā]屋之二，原12-13号住宅，现位于中山大学南校园东南区241号。该建筑为洛克菲勒基金会中国医业董事会（The China Medical Board of the Rockefelle...",
  ...
  },
  {
    ...
    position: "南校园278号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "谭礼庭屋，又称同学屋、同学会屋、岭南同学屋，原3-4号住宅，现位于中山大学南校园东南区278号，坐落在怀士堂东南侧。该建筑由岭南大学校董谭礼庭先生捐资建造，于1925年落成",
  ...
  },
  {
    ...
    position: "南校园279号",
    tags: ["运动"],
    shortDesc: "马应彪夫人护养院，原88号建筑，现位于中山大学东南区279号A。该建筑由岭南大学首位华人校董、先施公司创办人马应彪先生以其夫人霍庆棠的名义捐建，于1917年设计，1919年落成，设计者为上海布道...",
  ...
  },
  {
    ...
    position: "南校园280号",
    tags: ["宿舍区","活动","人文"],
    shortDesc: "麻金墨屋二号，又称第二麻金墨屋，原10号住宅，现位于中山大学东南区280号。该建筑由美国芝加哥慈善家麻金墨夫人（Mrs",
  ...
  },
  {
    ...
    position: "南校园492号",
    tags: ["老建筑","历史","活动"],
    shortDesc: "怀士堂，又称小礼堂，是岭南大学康乐园的标志性建筑之一，位于中央大草坪的起点，坐南朝北。建筑整体红灰墙、翠蓝瓦，绿树环绕中显得挺拔典雅",
  ...
  },
  {
    ...
    position: "四墩楼前",
    tags: ["雕塑","地标","拍照","活动"],
    shortDesc: "鲁迅先生像（Statue of Lu Xun），位于中山大学广州校区南校园中文堂东南侧。这尊半身雕像静静伫立，鲁迅身着白色长衫，浓密的八字胡下是对时代的深沉思索，忧郁的眼神中燃着不灭的星火 ——...",
  ...
  },
  {
    ...
    tags: ["雕塑","地标","拍照","活动"],
    shortDesc: "中山大学校训：博学 审问 慎思 明辨 笃行 这十个字源自《礼记·中庸》：“博学之，审问之，慎思之，明辨之，笃行之”。亦为1924年国立广东大学成立典礼上孙中山以大元帅身份发表的《训词》核心内容，...",
  ...
  },
  {
    ...
    position: "南校园305号",
    tags: ["老建筑","历史","宿舍区","人文"],
    shortDesc: "希伦高屋 由美国慈善家 海伦·希伦高女士（Miss Hellen Gould） 捐建，是岭南大学康乐园内的重要教师住宅之一。自落成以来，这里先后成为多位中外知名学者的寓所，见证了岭南学术文化的发展历程",
  ...
  },
  {
    ...
    position: "南校园306号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "黑石屋，原11号住宅，现位于中山大学东北区306号。该楼由美国芝加哥的伊沙贝·布勒斯顿（Mrs",
  ...
  },
  {
    ...
    category: "dormitory",
    position: "南校园309号",
    tags: ["自习","藏书","宿舍区","活动","人文"],
    shortDesc: "麻金墨屋一号，原1号住宅，现位于中山大学东北区309号。该楼由美国芝加哥慈善家麻金墨夫人（Mrs",
  ...
  },
  {
    ...
    position: "南校园304号",
    tags: ["宿舍区","医疗","人文"],
    shortDesc: "美臣屋二号，原19号住宅，现位于中山大学东北区304号。该楼为美国慈善家George Grant Mason捐建的两栋教师住宅之一，于1919–1920年间落成，稍晚于美臣屋一号",
  ...
  },
  {
    ...
    position: "南校园303号",
    tags: ["老建筑","历史"],
    shortDesc: "神甫屋，又称马利诺堂，是康乐园内唯一一栋由天主教会建造并用于传播宗教教义的建筑。 历史沿革： 建造背景：由天主教马利诺会（Maryknoll Fathers）资助兴建，作为岭南大学中从事布道与教...",
  ...
  },
  {
    ...
    position: "南校园308号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "积臣屋，又译杰克逊屋、泽臣屋、则臣屋，原20号住宅，现位于中山大学东北区308号。该楼由时任岭南学校董事会主席积臣先生（Samuel Macauley Jackson）捐建，美国纽约斯道顿建筑师...",
  ...
  },
  {
    ...
    position: "南校园302号",
    tags: ["运动","上课","活动"],
    shortDesc: "英东体育馆位于中山大学广州校区南校园西南侧，坐落于英东田径场东侧，是校园内标志性的现代体育建筑。该馆由香港著名实业家、慈善家霍英东先生捐资兴建，因而命名为“英东体育馆”",
  ...
  },
  {
    ...
    position: "南校园210号",
    tags: ["宿舍区","活动"],
    shortDesc: "新女学，又称“广寒宫”，由广东信托公司建筑师黄玉瑜设计，于1929年落成。岭南大学早在20世纪初即开中国近代教育男女同校之先河",
  ...
  },
  {
    ...
    position: "园东湖南岸",
    tags: ["雕塑","地标","拍照"],
    shortDesc: "“摇篮”铜像静静伫立于康乐园东湖畔，宛如一段深情往事的凝固。它诞生于中山大学建校七十七周年之际，由海内外17个校友会共同捐资铸就，以此寄托校友们对母校的绵长眷恋，象征中山大学作为人才培育摇篮的深厚底蕴",
  ...
  },
  {
    ...
    position: "园东湖北岸",
    tags: ["雕塑","地标","拍照"],
    shortDesc: "冼星海雕像（Statue of Xian Xinghai）坐落于中山大学广州校区南校园东湖北岸，宛如一位永恒的守望者，静静凝望着这片他曾挥洒青春与理想的土地。 雕像以汉白玉精心雕琢，由岭南大学香...",
  ...
  },
  {
    ...
    tags: ["老建筑","历史","运动","上课","医疗"],
    shortDesc: "翘燊堂（Kiw San Hall）由澳门著名人士李翘燊捐建，落成于1933年。1931年前后，岭南大学为解决附属中学校舍紧张问题，决定筹款兴建新中学，先后建成五栋建筑，形成新中学建筑群",
  ...
  },
  {
    ...
    position: "南校园359号",
    tags: ["餐饮","景观","拍照","上课","活动"],
    shortDesc: "松涛园食堂，2020年正式亮相，是校园生活区与教学区之间的重要枢纽。该食堂于2023年以全新面貌落成，总建筑面积达24031",
  ...
  },
  {
    ...
    position: "南校园369号",
    tags: ["自习","藏书","运动","上课","活动"],
    shortDesc: "中山大学体育馆，位于广州大学城中山大学新校区主轴线南端，北邻图书馆，南接大学城中环路。建筑面积约11600平方米，包括主馆及三层副馆，按国际比赛标准建造，可容纳5000名观众，其中设有1700余...",
  ...
  },
  {
    ...
    position: "善思堂（386）旁",
    tags: ["景观","拍照"],
    shortDesc: "松园湖，位于中山大学广州校区南校园东北部，毗邻松园，因而得名，又称“松园湖”。 康乐园自岭南大学时期起便以园林景致著称，昔日共有十三处湖泊池沼，现仅存四个，被称为“中大四湖”，分别是东湖、西湖、...",
  ...
  },
  {
    ...
    position: "南校园389号",
    tags: ["上课","活动"],
    shortDesc: "第二教学楼（389栋） 中山大学广州校区南校园北侧的第二教学楼，现为公共教学的重要场所。该楼始建于上世纪，2022年7月起学校对其进行全面翻新改造，改造面积约1",
  ...
  },
  {
    ...
    position: "南校园378号",
    tags: ["宿舍区","医疗","活动"],
    shortDesc: "卡彭特楼（Carpentier Hall） 卡彭特楼因美国纽约豪拉斯·卡彭特将军（Horace Carpentier）遗赠2。5万美元而建，由纽约斯道顿建筑师事务所于1910年设计，1911年落成",
  ...
  },
  {
    ...
    position: "南校园392号",
    tags: ["老建筑","历史","上课"],
    shortDesc: "林护堂建于1933年，由香港实业家、慈善家林护先生（Lam Woo, 1871–1933）捐资兴建，以其名字命名。林护曾任香港大学校董，热心支持教育，是当年港澳华人社会最主要的教育捐助者之一",
  ...
  },
  {
    ...
    position: "南校园394号",
    tags: ["老建筑","历史","上课","宿舍区","人文"],
    shortDesc: "叶葆定堂位于中山大学岭南（大学）学院，由岭南学院名誉主席、名誉教授叶葆定先生（1908—2008）慷慨捐资兴建，以其名字命名。大楼为岭南国际MBA教育中心的核心建筑，承载着岭南学院对国际化商学教...",
  ...
  },
  {
    ...
    position: "-",
    tags: ["校门","地标"],
    shortDesc: "中山大学牌坊，简称“中大牌坊”，位于广州校区南校园北门，珠江南岸广场，是广州人心目中最具代表性的中大地标。整座牌坊古色古香，庄严大气，用钢筋三合土筑成，外饰以花岗石砌成，前后石柱分两行，共分五门...",
  ...
  },
  {
    ...
    position: "南校园586号",
    tags: ["老建筑","历史","上课","活动"],
    shortDesc: "伍沾德堂位于中山大学广州校区南校园西南部，是一座承载着校友深情与教育使命的标志性建筑。该堂由著名爱国侨领、慈善家伍沾德博士慷慨捐资兴建，以其名字命名，寓意“以己之力，泽被母校”",
  ...
  },
  {
    ...
    position: "南校园583号",
    tags: ["上课","活动","人文"],
    shortDesc: "丰盛堂是中山大学广州校区南校园的一幢现代化实验大楼，由化学学院教授刘汉钦与其夫人康北笙于1995年集资650万元倡建而成，象征着学术伉俪的爱国情怀与无私奉献。 丰盛堂的建设不仅改善了化学院的科研...",
  ...
  },
  {
    ...
    position: "-",
    tags: ["上课","活动"],
    shortDesc: "中山大学西北门位于广州校区南校园的西北角，毗邻生活区与教学区的交界地带，是师生日常出入的重要通道之一。 西北门不仅连接着校园内部主干道与周边居民区，也通往生活配套设施和邻近商区，因而成为学生日常...",
  ...
  },
  {
    ...
    position: "南校园576号",
    tags: ["自习","藏书"],
    shortDesc: "伍舜德图书馆位于中山大学广州校区南校园哲生堂北，1996年9月正式开放，是学校重要的学科分馆之一。 该馆由岭南大学校友、香港美心食品集团创始人伍舜德（1912—2003）及美国岭南基金会捐资兴建...",
  ...
  },
  {
    ...
    position: "南校园577号",
    tags: ["老建筑","历史","人文"],
    shortDesc: "岭南堂位于中山大学广州校区南校园，是一幢三层建筑，由岭南大学校友捐建，建成于1994年，由岭南建筑大师佘畯南与莫伯治设计。 规划争议： 在中山大学校园规划调整中，岭南堂是否拆除曾引发热议",
  ...
  },
  {
    ...
    position: "南校园388号",
    tags: ["宿舍区","人文"],
    shortDesc: "马应彪招待所位于中山大学广州校区南校园东北区388号，建成于民国十一年（1922年）。该建筑由岭南大学校董、著名实业家马应彪先生全额出资兴建，并购置室内家具及陈设，因此以其名字命名",
  ...
  },
  {
    ...
    position: "南校园571号",
    tags: ["老建筑","历史","上课"],
    shortDesc: "哲生堂位于中山大学广州校区南校园西北区571号，原12号建筑。该楼由国民政府铁道部拨款建设，美国建筑师墨菲（Henry Killam Murphy）于1930年设计，1929年12月奠基，193...",
  ...
  },
  {
    ...
    position: "南校园565号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "陆祐堂位于中山大学广州校区南校园西北区565号，原33号建筑。由美国建筑师墨菲（Henry Killam Murphy）设计，1930年开工，1931年落成",
  ...
  },
  {
    ...
    position: "南校园555号",
    tags: ["老建筑","历史","宿舍区"],
    shortDesc: "爪哇堂位于中山大学广州校区南校园西北区555号，原34号建筑。由上海布道团建筑师事务所设计师埃德蒙兹（Jas",
  ...
  },
  {
    ...
    position: "南校园543号",
    tags: ["自习","藏书","上课"],
    shortDesc: "中山大学博物馆位于广州南校园中轴线西侧，与东侧图书馆遥相呼应，形成中轴对称。作为大学文化积淀的集中展现，它不仅是学校历史与文化的实物表征，更是中大一流大学建设的重要标志",
  ...
  },
  {
    ...
    position: "博物馆（543）前",
    tags: ["活动"],
    shortDesc: "八角亭，原55号建筑，现位于中山大学广州校区南校园西北区542号，由上海布道团建筑师事务所（Mission Architects Bureau, Shanghai）设计师埃德蒙兹（Jas。 R",
  ...
  },
  {
    ...
    position: "八角亭前",
    tags: ["校门","地标"],
    shortDesc: "乙丑进士牌坊（Memorial Archway for the 1625 Imperial Scholars）建于明崇祯八年（1635年），为表彰天启年间广东籍七位进士——梁士济、李斯觉、罗亦儒...",
  ...
  },
  {
    ...
    tags: ["运动","活动","人文"],
    shortDesc: "惺亭，又称钟亭、烈士钟亭，坐落于中山大学康乐园内。该亭由岭南大学“惺社”毕业生为报本思源、纪念三位校友烈士——史坚如、区励周、许耀章而筹资兴建，由美国建筑师墨菲（Henry Killam Mur...",
  ...
  },
  {
    ...
    position: "中轴线",
    tags: ["雕塑","地标","拍照"],
    shortDesc: "孙中山先生铜像（Statue of Dr。 Sun Yat-sen）矗立于中山大学广州校区南校园的中轴线上，端庄肃立，面向中央大草坪，成为康乐园最具象征性的标志之一",
  ...
  },
  {
    ...
    position: "南校园536号",
    tags: ["老建筑","历史"],
    shortDesc: "史达理堂，又称陆达理堂、科学馆、理学馆，原52号建筑，现西北区536号。因与东院的马丁堂相对，亦被称为“西院”",
  ...
  },
  {
    ...
    position: "南校园558号",
    tags: ["上课"],
    shortDesc: "光电材料与技术国家重点实验室依托中山大学建设，由国家科技部批准设立。其前身为著名光谱物理学家、教育家高兆兰先生于1984年倡建的超快速激光光谱学国家重点实验室，是全国首批建设的10个国家重点实验室之一",
  ...
  },
  {
    ...
    position: "南校园537号",
    tags: ["老建筑","历史","活动","人文"],
    shortDesc: "十友堂位于中山大学西北区537号。该堂由岭南大学10位校友各出1万元，并联合数十华侨和商会共同捐建，因而得名“十友堂”",
  ...
  },
  {
    ...
    tags: ["宿舍区"],
    shortDesc: "模范村建筑群，又称“西区住宅”，是岭南大学教职员住宅区的典型代表。建筑群于1915年至1930年间，以校友捐赠与学校拨款相结合的方式先后建成十余栋村屋，成为康乐园内教师住宅的缩影",
  ...
  },
  {
    ...
    position: "南校园505号",
    tags: ["宿舍区","活动"],
    shortDesc: "中学第三寄宿舍，原75号建筑，现位于西北区505号。该建筑由美国纽约斯道顿建筑师事务所（Stoughton & Stoughton Architects）于1909年设计，1912年落成",
  ...
  },
  {
    ...
    position: "南校园503号",
    tags: ["老建筑","历史","上课"],
    shortDesc: "永芳堂位于中山大学广州校区南校园中轴线上，是校园的重要地标建筑之一。1990年，由著名爱国华侨、南源永芳集团董事长姚美良先生捐资一千万元人民币兴建",
  ...
  },
  {
    ...
    position: "南校园501号",
    tags: ["宿舍区"],
    shortDesc: "中学第四寄宿舍位于中山大学广州校区南校园西北区501号，原编号76号建筑，落成于1916年。 捐赠背景： 该楼由吴有胜、吴胜鹏、周佳、陈占梅、区慎刚、林推迁、林义顺、朱子桥、斐君、简照南、郑发、...",
  ...
  },
  {
    ...
    position: "南校园517号",
    tags: ["自习","藏书","餐饮","上课","活动"],
    shortDesc: "学人书境位于中山大学广州校区南校园西北区517号，毗邻学一食堂，处于学院办公区、教学楼和教职工生活区之间的连接带，于2019年8月31日正式开业。 空间与设计： 学人书境坐落于红砖绿瓦的百年红楼...",
  ...
  },
  {
    ...
    position: "南校园507号",
    tags: ["宿舍区"],
    shortDesc: "中学第一寄宿舍，原73号建筑，现位于西北区507号，是岭南大学第一栋由本国校友捐建的建筑物，落成于1910年3月。 历史沿革： 该楼由美国纽约斯道顿建筑师事务所（Stoughton & Stou...",
  ...
  },
  {
    ...
    position: "南校园609号",
    tags: ["餐饮","景观","拍照"],
    shortDesc: "康乐园餐厅（Kangleyuan Dining Hall）位于中山大学广州校区南校园，是伴随几代中大师生成长的校园食堂记忆。餐厅建筑朴素典雅，红砖绿瓦的岭南风格与康乐园的整体环境融为一体",
  ...
  },
  {
    ...
    category: "landscape",
    position: "康乐园餐厅后",
    tags: ["景观","拍照","上课","宿舍区","活动"],
    shortDesc: "园西湖（Yuanxi Lake）位于中山大学广州校区南校园西部，松涛园宿舍区与西区教学生活区之间，是校园内一片静谧而富有诗意的水域景观。 景观特色： 湖面开阔，四季水色各具韵味：春日新绿倒映湖中...",
  ...
  },
  {
    ...
    shortDesc: "蒲园食堂（Pu Garden Dining Hall）位于中山大学广州校区南校园西南生活区，毗邻学生宿舍群，是中大师生日常就餐的主要场所之一。 环境与格局： 食堂外观延续红砖绿瓦的岭南校园风格，...",
  ...
  },
  {
    ...
    position: "-",
    tags: ["校园"],
    shortDesc: "西门（West Gate）虽名为“西门”，却并非朝西而开，而是朝南敞开大门，成为南校园极具趣味性的入口之一。 地理位置与功能： 西门位于教职工家属区的必经之路，既是师生进出的通道，也是联系校园与...",
  ...
  },
  {
    ...
    position: "-",
    tags: ["上课"],
    shortDesc: "中山大学西北门位于广州校区南校园的西北侧，毗邻生活区与教学区的交界地带，是师生日常出入的重要通道之一。 小西门外连接着中大菜市场",
  ...
  },
  {
    ...
    position: "南校园629号",
    tags: ["老建筑","历史","上课","活动"],
    shortDesc: "震寰堂（Zhenhuan Hall）原由中山大学管理学院使用，现在为数学学院使用，是学院重要的学术与培训活动场所。 建筑与功能： 震寰堂作为数学学院的核心大楼之一，常年承载教学、培训、学术会议与...",
...
export function getPlacesByCategory(category) {
  ...
  return campusLocations.filter(p => p.category === category);
}

export function searchPlaces(keyword) {
  if (!keyword?.trim()) return campusLocations;
  const q = keyword.trim().toLowerCase();
  return campusLocations.filter(p =>
    p.name.toLowerCase().includes(q) || p.tags?.some(t => t.toLowerCase().includes(q)) ||
    p.shortDesc?.toLowerCase().includes(q) || p.description?.toLowerCase().includes(q) ||
